...
# Input directory
InputDir <- paste0("/Users/XXW004/Documents/Projects/DarylMcleod/Results/Results_03242025/Intensity_Analyses_NormalGFRVsControls/MethodIntegration/")

# Output directory
OutDir<- paste0("/Users/XXW004/Documents/Projects/DarylMcleod/Results/Results_03242025/Intensity_Analyses_NormalGFRVsControls/MethodIntegration/Figures/")
...
ggsave("FinalIntegratedMethods_volcanoPlots_higheGFRhigheGFRPUVvsControl.pdf", plot =FinalIntegratedMethodsVolcano, height = 4, width = 4 )
...
write.csv(UpRegulatedProteinsFinal, "UpRegulatedProteins_higheGFRPUVvsControl.csv")


write.csv(DownRegulatedProteinsFinal, "DownRegulatedProteins_higheGFRPUVvsControl.csv")
...
ggsave(paste0(PathwayName, "_FC_HeatMap_inCollecDuct_higheGFRPUVvsControl.pdf"),plot =RequestedGenesHeatmap, height = 3, width =5 )
RequestedGenesHeatmap
...
ggsave(paste0(PathwayName, "_FC_DotPlot_inCollecDuct_DKD_higheGFRPUVvsControl.pdf"),plot =RequestedGenesDotPlot, height = 9, width = 4 )
...
enrichMap(CgoUp)
write.table(CgoUpSimplify, file="higheGFRPUVvsControl.UpRegulatedGenes_simplified.GO.txt", sep="\t", quote=F)
write.table(CgoDownSimplify, file="higheGFRPUVvsControl.DownRegulatedGenes_simplified.GO.txt", sep="\t", quote=F)
CgoDownSimplify@result %>% head(n=10)
CgoUpSimplify@result %>% head(n=20)
write.table(CgoUp, file="higheGFRPUVvsControl.UpRegulatedGenes.GO.txt", sep="\t", quote=F)
write.table(CgoDown, file="higheGFRPUVvsControl.DownRegulatedGenes.GO.txt", sep="\t", quote=F)
