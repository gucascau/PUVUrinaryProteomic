...
SelectedColumnForPublication<- c("ID","Limma_logFC",	"Limma_AveExpr",	"Limma_P.Value.x",	"Limma_adj.P.Val", "DEqMS_sca.P.Value.x",	"DEqMS_sca.adj.pval",	"DEqMS_log.sca.pval","proDA_pval.x",	"proDA_adj_pval",	"proDA_diff","proDA_avg_abundance", "ROTS_logFC",	"ROTS_P.Value.x",	"ROTS_adj.pval", "Wilcoxon_logFC",	"Wilcoxon_P.Value.x",	"Wilcoxon_adj.pval", "DEP_LCase_vs_HCase_p.val.x",	"DEP_LCase_vs_HCase_p.adj",	"DEP_LCase_vs_HCase_ratio", "MSstats_log2FC", "MSstats_pvalue.x",	"MSstats_adj.pvalue", "Mascot_GFRwilpvalue", "Mascot_GFRPadjust", "Mascot_GFRLogFC", "max_logFC", "FinalP_empirical",	"FinalP_Fisher",	"FinalP_Tippett",	"FinalP_Stouffer",	"FinaladjP_Fisher",	"FinaladjP_Tippett",	"FinaladjP_Stouffer",	"FinaladjP_empirical")
